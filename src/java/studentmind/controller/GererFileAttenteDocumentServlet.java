    ...
    public String afficheFileAttenteDocument() {
        ...
        for (Document doc : liste){
               html += "<tr>"                    
                    ...
                    + "<form method='POST' action='./gerer-file-attente-document.html'>"
                    + "<input type='image' src=\"img/accepter.png\" title=\"Valider\" alt=\"Valider\" onclick='ValiderDoc();'/>"
                    + "<input type='image'src=\"img/delete.png\" title=\"Supprimer\" alt=\"Supprimer\" onclick='RetirerDoc();'/>"
