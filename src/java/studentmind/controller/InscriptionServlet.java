...
public class InscriptionServlet extends HttpServlet {
    ...
    if (prenom==null || prenom.isEmpty()){
        mesNom="Veuillez à remplir correctement le prénom";
    ...
    if ((mdp==null || mdp.isEmpty()) && (mdp2==null || mdp2.isEmpty())){
        mesEmail="Veuillez à remplir correctement le mot de passe";
        champOk = false;
    }
    if (!(mdp2.equals(mdp))){
        mesEmail+= "Les mots de passe ne sont pas les mêmes";
        champOk = false;
    }
